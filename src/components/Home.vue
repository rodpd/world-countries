...
<main class="mt-4 bg-mgray-200">
	<div class="grid grid-cols-4 gap-12 px-6 py-6 md:gap-0 md:ml-14">
		<div class="col-span-4 md:col-span-2 py-4 rounded-md shadow-md sm:w-[40vw] bg-mgray-100">
	...
	<div v-if="countries" class="flex flex-wrap gap-8 px-16 py-4">
